...
@section('content')
    <div style="margin: 0 auto">
        ...
        <form method="POST" class="py-5 text-center">
            @csrf
            ...
            @endif
            <input name="password_confirmation" type="password" class="form-control mb-3 offset-md-3 col-md-6" style="text-align:center;" placeholder="Confirm Password">
            <input type="submit" class="btn btn-lg btn-primary btn-block mb-3 offset-md-3 col-md-6" value="Sign up">
